...
class CheckoutController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        if ($request->payment_option != null) {
            ...
            if ($request->payment_option != 'paystack' && $request->payment_option != 'flutterwave') {
            ...
            if ($request->session()->get('order_id') == null) {
                if ($request->payment_option == 'paypal') {
                    ...
                    $flutterwave = new RaveController;
                    return $flutterwave->redirectToGateway($request);
    ...
    public function store_delivery_info_for_api(Request $request, $id)
    {
    ...
    public function remove_coupon_code(Request $request)
    {
        ...
        return view('frontend.partials.cart_summary', compact('carts', 'shipping_info'));
        //        return back();
    }
