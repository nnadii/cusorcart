...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h3">{{translate('All Delivery Companies')}}</h1>
        </div>

        <div class="col text-right">
            <a href="{{ route('delivery-boys.create') }}" class="btn btn-circle btn-info">
                <span>{{translate('Add New Delivery Company')}}</span>
            </a>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-header d-block d-lg-flex">
        <h5 class="mb-0 h6">{{translate('Delivery Companies')}}</h5>
        <div class="">
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                ...
                                <a href="{{route('delivery-boy.duplicate', ["id" => $delivery_boy->user->id])}}"
                                           class="dropdown-item">
                                            {{translate('Duplicate courier')}}
                                </a>
		
                                <a href="#" class="dropdown-item confirm-delete" data-href="{{route('delivery-boy.delete', ["id" => $delivery_boy->user->id])}}" class="">
                                    {{translate('Delete')}}
                                </a>
                            </div>
                        </div>
