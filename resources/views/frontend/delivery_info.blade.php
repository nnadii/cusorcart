            ...
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                <div class="col-xxl-8 col-xl-10 mx-auto text-left">
                    <form class="form-default" action="{{ route('checkout.store_delivery_info') }}" role="form"
                                                        ...
                                                        <div class="shadow-sm bg-white p-4 rounded mb-4">
                                                            <div class="row gutters-5">
                                                                <div class="col-md-12 mb-3">
                                                                    ...
                                                                    <label class="aiz-megabox d-block bg-white mb-0">
                                                                        <input type="radio" required
                                                                            name="ship_detail_id{{ App\User::where('user_type', 'admin')->first()->id }}"
                                                                            id="service_charge" value="{{ $shipkg }}"
                                                                            onclick="service()">
                                                                        <input type="hidden" name="ship_id[]"
                                                                            value="{{ $ship->id }}">
                                                                        <input type="hidden" name="shipping_tax[]"
                                                                            value="{{ $ship->shipping_tax }}">
                                                                        ...
                                                                        <span class="d-flex p-3 aiz-megabox-elem">
                                                                            ...
                                                                            <span class="flex-grow-1 pl-3 text-left">
                                                                                ...
                                                                                <div>
                                                                                    <span
                                                                                        class="opacity-60">{{ translate('Shipped By:') }}:</span>
                                                                                    <span
                                                                                        class="fw-600 ml-2">{{ $ship->user->name }}</span>
                                                                                </div>


                                                                                <div>
                                                                                    <span
                                                                                        class="opacity-60">{{ translate('Sold By:') }}:</span>
                                                                                    <span
                                                                                        class="fw-600 ml-2">{{ route('home') }}
                                                                                        Services ENT</span>
                                                                                </div>
                                                                                ...
                                                                                <div>
                                                                                    <span
                                                                                        class="opacity-60">{{ translate('Arrival Day') }}:</span>
                                                                                    <span
                                                                                        class="fw-600 ml-2">{{ Carbon\Carbon::now()->addDays($ship->transit_day)->format('l, M d, Y') }}</span>
                                                                                </div>
                                                                            ...
                                                                            <span class="flex-grow-1 pl-3 text-left">
                                                                                ...
                                                                                <div>
                                                                                    <span
                                                                                        class="opacity-60">{{ translate('Shipped By:') }}:</span>
                                                                                    <span
                                                                                        class="fw-600 ml-2">{{ $ship1->user->name }}</span>
                                                                                </div>
                                                                                ...
                                                                                <div>
                                                                                    <span
                                                                                        class="opacity-60">{{ translate('Arrival Day') }}:</span>
                                                                                    <span
                                                                                        class="fw-600 ml-2">{{ Carbon\Carbon::now()->addDays($ship1->transit_day)->format('l, M d, Y') }}</span>
                                                                                </div>
                                                                            ...
                                                                            <span class="flex-grow-1 pl-3 text-left">
                                                                                ...
                                                                                <div>
                                                                                    <span
                                                                                        class="opacity-60">{{ translate('Shipped By:') }}:</span>
                                                                                    <span
                                                                                        class="fw-600 ml-2">{{ $ship2->user->name }}</span>
                                                                                </div>
                                                                                ...
                                                                                <div>
                                                                                    <span
                                                                                        class="opacity-60">{{ translate('Arrival Day') }}:</span>
                                                                                    <span
                                                                                        class="fw-600 ml-2">{{ Carbon\Carbon::now()->addDays($ship2->transit_day)->format('l, M d, Y') }}</span>
                                                                                </div>
                                                                            ...
                                                                            <span class="flex-grow-1 pl-3 text-left">
                                                                                ...
                                                                                <div>
                                                                                    <span
                                                                                        class="opacity-60">{{ translate('Shipped By:') }}:</span>
                                                                                    <span
                                                                                        class="fw-600 ml-2">{{ $ship3->user->name }}</span>
                                                                                </div>
                                                                                ...
                                                                                <div>
                                                                                    <span
                                                                                        class="opacity-60">{{ translate('Arrival Day') }}:</span>
                                                                                    <span
                                                                                        class="fw-600 ml-2">{{ Carbon\Carbon::now()->addDays($ship3->transit_day)->format('l, M d, Y') }}</span>
                                                                                </div>
                        ...
                        <button style="float: right;margin-top: -26px;" type="submit"
