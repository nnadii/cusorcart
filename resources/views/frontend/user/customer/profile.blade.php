...
@section('panel_content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('customer.profile.update') }}" autocomplete="off"  method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="tel" class="form-control"role="presentation" autocomplete="off" placeholder="{{ translate('Enter Your Phone Number')}}" name="phone" value="{{ Auth::user()->phone }}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="password" class="form-control" autoComplete="new-password"  placeholder="{{ translate('New Password') }}" name="new_password">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">{{ translate('Confirm Password') }}</label>
                    <div class="col-md-10">
                        <input type="password" class="form-control" autocomplete="false" placeholder="{{ translate('Confirm Password') }}" name="confirm_password">
                    </div>
                </div>
