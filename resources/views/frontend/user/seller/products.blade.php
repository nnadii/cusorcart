...
@section('panel_content')
    ...
    <div class="row gutters-10 justify-content-center">
        ...
        <div class="col-md-4 mx-auto mb-3" >
                @php
                    $seller_package_working = \App\Seller::where('user_id',Auth::user()->id)->first();
                @endphp
                @if($seller_package_working->verification_status == 1) 
            ...
            <a href="{{ route('shop.verify') }}">
                <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition">
                    ...
                    <div class="fs-18 text-primary">{{ translate('Please Verify Now') }}</div>
                </div>
            </a>
            @endif
        ...
        @endphp
        <div class="col-md-4">
            <a href="{{ route('seller_packages_list') }}" class="text-center bg-white shadow-sm hov-shadow-lg d-block p-3 rounded">
