            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="name"
                                    ...
                                    value="{{ $product->getTranslation('name') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Weight in Kg') }}</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="kg" value="{{ $product->kg }}"
                                    placeholder="{{ translate('Weight in Kg') }}" required>
                            </div>
                        </div>
                                ...
                                <select class="form-control" name="price_currecny" required>
                                    ...
                                    @foreach (App\Currency::where('status', '1')->get() as $itemcurrency)
                                        <option value="{{ $itemcurrency->id }}"
                                            @if ($product->price_currecny == $itemcurrency->id) selected @endif>{{ $itemcurrency->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    @if ($product->stocks->first() != '')
                                        <input type="number" lang="en"
                                            value="{{ $product->stocks->first()->qty }}" step="1"
                                            placeholder="{{ translate('Quantity') }}" name="current_stock"
                                            class="form-control" required>
                                    @else
                                        <input type="number" lang="en" required step="1"
                                            placeholder="{{ translate('Quantity') }}" name="current_stock"
                                            class="form-control" required>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-6">
                                    @if ($product->stocks->first() != '')
                                        <input type="text" placeholder="{{ translate('SKU') }}"
                                            ...
                                            class="form-control">
                                    @else
                                        <input type="text" placeholder="{{ translate('SKU') }}" required
