...
@if (request()->input('from_app') == 'yes')
<style>
    header, .btn1, footer,#navFooter,#footer-links{
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="category_id" id="category_id"
                                    ...
                                    @foreach ($categories as $category)
                                        <option disabled value="{{ $category->id }}">{{ $category->getTranslation('name') }}
                                        </option>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">Weight Value (This will be converted to kg
                                equivalent)</label>
                            <div class="col-md-8">
                                <input type="number" class="form-control" id="weight_value"
                    ...
                    <div class="card-body">
                        ...
                        <div id="show-hide-div">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input required type="number" lang="en" min="0" value="0"
...
@section('script')
    <script  type="module">
        ...
        $('#unit_select').on('change', function() {
            ...
            const weight_value = parseInt($('#weight_value').val());
