                            ...
                            <tr style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
                                <td style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                    <div class="text" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: rgba(0, 0, 0, .3); padding: 0 2.5em; text-align: center;">
                                        <h2 style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; font-family: 'Playfair Display', sans-serif; margin-top: 0; color: #000; font-size: 34px; margin-bottom: 0; font-weight: 300;">{{ translate('Message') }}</h2>
                                        ...
                                        <p style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;"><b style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">{{ translate('Message') }}:</b>{{ $details }}</p>
                                        <a class="btn btn-primary btn-md" href="{{ $link }}" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; text-decoration: none; padding: 5px 20px; display: inline-block; border-radius: 5px; background: #feb062; color: #ffffff;">{{ translate('See Details') }}</a>
