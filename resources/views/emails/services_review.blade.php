                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 30px 30px 40px;font-family:arial,helvetica,sans-serif;" align="left">
                                                                                                            <div class="v-text-align" style="color: #333333; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                                                                ...
                                                                                                                <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
                                                                                                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">
                                                                                                                    Thank you for submitting your shipping package to cusorcart
                                                                                                                </p>
                                                                                                            </div>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 30px 80px 40px;font-family:arial,helvetica,sans-serif;" align="left">
                                                                                                            <div class="v-text-align" style="color: #333333; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                                                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; font-family: 'Crimson Text', serif;">Thank you for creating a Logistic Services in the Cusorcart Express. As part of the 
                                                                                                                    <strong>Cusorcart to Merchant  Agreement</strong>, all created Logistic Services passes through a review to ensure that all expected requirements 
                                                                                                                    are met & uploaded fourth without falsity. You will receive an approval email after your Logistic Services is approved
                                                                                                                </p>
                                                                                                                <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
