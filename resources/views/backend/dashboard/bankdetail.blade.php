...
<div class="row">
    <div class="col-lg-6 mx-auto">
        <div class="card">
            ...
            <form class="form-horizontal" action="bank-detail-update" method="POST" enctype="multipart/form-data">@csrf
                <div class="card-body">
            ...
            @else
            <form class="form-horizontal" action="bank-detail-post" method="POST" enctype="multipart/form-data">@csrf
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="name">Bank Name</label>
                        <div class="col-sm-9">
