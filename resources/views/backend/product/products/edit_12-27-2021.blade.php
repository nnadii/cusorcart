                    ...
                    <div class="card-body">
                        ...
                        <div id="show-hide-div">
                            <div class="form-group row" id="quantity">
                                ...
                                <div class="col-lg-6">
                                    <input required  type="number" lang="en" value="{{ optional($product->stocks->first())->qty }}" step="1" placeholder="{{translate('Quantity')}}" name="current_stock" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">
