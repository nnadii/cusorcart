                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row" id="brand">
                                ...
                                <div class="col-md-8">
                                    <input list="brands" class="form-control aiz-selectpicker" name="brand_id"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control" name="unit" id="unit"
                                        placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" required readonly>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">Weight Value (This will be converted to kg
                                    equivalent)</label>
                                <div class="col-md-8">
                                    <input type="number" step="0.000000001" class="form-control" id="weight_value"
                                        placeholder="Weight in selected unit above" required>
                                </div>
                                <label class="col-md-3 col-from-label">Weight in Kg</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="kg" id="weight_in_kg"readonly
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-md-3">
                                    <input type="text" class="form-control" value="Size Chart" disabled>
                                </div>
                                <div class="col-md-8">
                                    <input type="file" class="form-control" value="" name="size_chart">
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="card-body">
                            <div class="form-group row" style="margin-bottom: 70px;">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="quill-text-editor"></div>
                                </div>
                            </div>
                        </div>
                    </div>
