                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!--    <label class="col-md-3 col-from-label">{{ translate('Rating') }} <span class="text-danger">*</span></label>-->
                            <!--    <div class="col-md-8">-->
                            <!--        <select class="form-control aiz-selectpicker" name="rating" id="rating" data-live-search="true" required>-->

                            <!--            <option disabled value="0.00"> -->
                            <!--           -- NO RATING-->
                            <!--            </option>-->
                            <!--             <option  value="5.00"> -->
                            <!--           -- 5 STARS-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control aiz-selectpicker" id="unit_select">
                                        <option value="">Select Unit</option>
                                        <option value="kilogram" @if ($product->getTranslation('unit', $lang) == 'kg') selected @endif>kilogram
                                        </option>
                                        <option value="gram" @if ($product->getTranslation('unit', $lang) == 'g') selected @endif>gram
                                        </option>
                                        <option value="milligram" @if ($product->getTranslation('unit', $lang) == 'mg') selected @endif>
                                            milligram</option>
                                        <option value="metric ton" @if ($product->getTranslation('unit', $lang) == 'MT') selected @endif>metric
                                            ton</option>
                                        <option value="long ton" @if ($product->getTranslation('unit', $lang) == 'LT') selected @endif>long ton
                                        </option>
                                        <option value="short ton" @if ($product->getTranslation('unit', $lang) == 'ST') selected @endif>short
                                            ton</option>
                                        <option value="pound" @if ($product->getTranslation('unit', $lang) == 'lb') selected @endif>pound
                                        </option>
                                        <option value="ounce" @if ($product->getTranslation('unit', $lang) == 'oz') selected @endif>ounce
                                        </option>
                                    </select>
                                    <input type="text" class="form-control" name="unit"
                                        placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}"
                                        value="{{ $product->getTranslation('unit', $lang) }}" readonly required>
                                </div>
                            </div>

                            <div class="form-group row"> <label class="col-md-3 col-from-label">Weight Value (This will be
                                    converted to kg
                                    equivalent)</label>
                                <div class="col-md-8">
                                    <input type="number" step="0.000000001" class="form-control" id="weight_value"
                                        placeholder="Weight in selected unit above">
                                </div>
                                <label class="col-lg-3 col-from-label">Weight in Kg<i class="las la-language text-danger"
                                        title="{{ translate('Translatable') }}"></i> </label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="kg" placeholder="Weight in Kg"
                                        value="{{ $product->kg }}" readonly required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="number" lang="en" class="form-control" name="min_qty"
                                        value="{{ (int) $product->min_qty }}" min="1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Unit Price Currency') }} <span
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="price_currecny" required>
                                        ...
                                        @foreach (App\Currency::where('status', '1')->get() as $itemcurrency)
                                            <option value="{{ $itemcurrency->id }}"
                                                @if ($product->price_currecny == $itemcurrency->id) selected @endif>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control aiz-date-range"
                                        value="{{ $product->discount_start_date ? $start_date . ' to ' . $end_date : '' }}"
                        ...
                        <div class="card-body">
                            <div class="form-group row" style="margin-bottom: 70px;">
                                <label class="col-lg-3 col-from-label">{{ translate('Description') }} <i
                                        ...
                                        title="{{ translate('Translatable') }}"></i></label>
                                <div class="col-lg-9">
                                    <input id="quill-slug" style="display:none" name="description" />
...
@section('script')
    <script  type="module">
        ...
        function convert_unit(params=0) {
                const unit = $('#unit_select').val(),
                    value = parseFloat(params),
                    kgValue = convert(value, unit).to('kilogram');
                $('#weight_in_kg').val(kgValue);
        }
        $('#unit_select').on('change', function() {
            ...
            const weight_value = parseFloat($('#weight_value').val());
            convert_unit(weight_value);

        });
        $('#weight_value').on('keyup', function(e) {
            const unit = $('#unit_select').val();
            ...
            if(unit.length===0){
                AIZ.plugins.notify('warning', 'Please select unit');
                $(this).val('');
                return false;
            }
