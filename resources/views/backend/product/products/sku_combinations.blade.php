@if (count($combinations[0]) > 0)
    <div class="alert alert-info" role="alert">
        ...
        <p>You don't have to choose images for different attributes with same color as variants with same color will
            share the same images.</p>
        <hr>
        <p class="mb-0">To remove an image you'll have to remove it from the variants it shares it with..</p>
    </div>
