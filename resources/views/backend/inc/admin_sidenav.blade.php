    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <!--                               <ul class="aiz-side-nav-list level-2">-->
                <!--                          <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('dashboard.wallet')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Wallet')}}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                           <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('send.withdraw.req')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Send Withdraw Request')}}</span>-->
                <!--                              </a>-->
                <!--                          </li> -->
                <!--                           <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('dashboard.withdraw')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Withdrawal Funds')}}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                           <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="#">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Total Earning')}}</span>-->
                <!--                              <span class="aiz-side-nav-arrow"></span>-->
                <!--                              </a>-->
                <!--                               <ul class="aiz-side-nav-list level-2">-->
                <!--                                    <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('dashboard.over.sale')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Overall Sales')}}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                                   </ul>-->
                <!--                          </li>-->
                ...
                <!--                          </li>-->
                <!--                          <li class="aiz-side-nav-item">-->
                <!--                              <a href="{{route('dashboard.allorder')}}" class="aiz-side-nav-link">-->
                ...
                <!--                               <ul class="aiz-side-nav-list level-2">-->
                <!--                          <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('open.ticket')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Open Ticket')}}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                           <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('conversations.admin_dashboard')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Collaborate with Team')}}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                          </ul>-->
                <!--                          </li>-->
                ...
                <!--                               <ul class="aiz-side-nav-list level-2">-->
                <!--                          <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('dashboard_shipping.index')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Shipping Setting')}}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                           <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('dashboard.location')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Location')}}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                          <li class="aiz-side-nav-item">-->
                <!--                             <a class="aiz-side-nav-link" href="{{route('admin_setting.index')}}">-->
                <!--                                <span class="aiz-side-nav-text">{{translate('Admin Setting')}}</span>-->
                <!--                            </a>-->
                <!--                            </li>-->
                <!--                           <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('dashboard.pickup')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Pickup Manager')}}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                           <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('dashboard.partner')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Partner Registration Form')}}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                          </ul>-->
                <!--                          </li>-->
                <!--                          <li class="aiz-side-nav-item">-->
                <!--                              <a href="{{ route('dashboard.language') }}" class="aiz-side-nav-link" >-->
                <!--                                  <span class="aiz-side-nav-text">{{ translate('Language') }}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                          <li class="aiz-side-nav-item">-->
                <!--                              <a href="{{route('dashboard.tracking')}}" class="aiz-side-nav-link">-->
                ...
                <!--                               <ul class="aiz-side-nav-list level-2">-->
                <!--                          <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('dashboard.feedback')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Feedback')}}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                           <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('score')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Score')}}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                           <li class="aiz-side-nav-item">-->
                <!--                              <a class="aiz-side-nav-link" href="{{route('dashboard.complaint')}}">-->
                <!--                                  <span class="aiz-side-nav-text">{{translate('Complains')}}</span>-->
                <!--                              </a>-->
                <!--                          </li>-->
                <!--                          </ul>-->
                <!--                          </li>-->
                ...
                <!--                  </li>-->
                <!--                  <li class="aiz-side-nav-item">-->
                <!--                      <a href="{{route('logic.bank')}}" class="aiz-side-nav-link {{ areActiveRoutes(['uploaded-files.create'])}}">-->
                <!--                          <i class="las la-folder-open aiz-side-nav-icon"></i>-->
                <!--                          <span class="aiz-side-nav-text">Logistic Bank Detail</span>-->
                <!--                      </a>-->
                <!--                  </li>-->
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            ...
                            <i class="las la-folder-open aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">Country Csv</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="admin/city" class="aiz-side-nav-link {{ areActiveRoutes(['uploaded-files.create'])}}">
                            <i class="las la-folder-open aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">City Csv</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="admin/state" class="aiz-side-nav-link {{ areActiveRoutes(['uploaded-files.create'])}}">
                            <i class="las la-folder-open aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">State Csv</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <span class="aiz-side-nav-text">{{translate('Logistics Partner')}}</span>
                    @if (env("DEMO_MODE") == "On")
                    <span class="badge badge-inline badge-danger">Addon</span>
                    @endif
                    <span class="aiz-side-nav-arrow"></span>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            ...
                            <span class="aiz-side-nav-text">{{translate('All Logistics Partner')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('delivery-boys.create')}}" class="aiz-side-nav-link {{ areActiveRoutes(['delivery-boys.create'])}}">
                            <span class="aiz-side-nav-text">{{translate('Add Logistics Partner')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('shipping.detail-form')}}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('logistics services')}}</span>
                            </a>
                        </li>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('shipping.create')}}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('add logistics service')}}</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('newsletters.index_custom')}}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('Custom Email') }}</span>
                            </a>
                        </li>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="javascript:void(0);" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{translate('Shipping Settings')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                            </a>
                            <ul class="aiz-side-nav-list level-3">
                                <li class="aiz-side-nav-item">
