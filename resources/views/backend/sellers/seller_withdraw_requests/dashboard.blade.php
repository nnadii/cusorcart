            ...
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                            ...
                            <tr>
                               ...
                               $order = App\Order::where('id',$logic->order_id)->first();
                            //   $user = App\User::where('user_type','seller')->orwhere('user_type','admin')->get();
                               ...
                               ?>
                                ...
                                <td class="">
    		                            ...
    		                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="/pay_withdraw/{{$logic->order_id}}"  title="{{ translate('Pay Now') }}">
    		                                <i class="las la-money-bill"></i>
    		                            </a>
    		                           
    		                           <a class="btn btn-soft-danger btn-icon btn-circle btn-sm" href="#" onclick="document.getElementById('reject{{$logic->order_id}}').submit()"  title="{{ translate('Reject') }}">
    		                                <i class="las la-money-bill"></i>
    		                                <form action="{{URL::to('paid_withdraw',$logic->order_id)}}" method="post" id="reject{{$logic->order_id}}">@csrf
    		                                <input name="payment_status" type="hidden" value="rejected" />
