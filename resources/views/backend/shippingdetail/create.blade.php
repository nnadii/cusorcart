    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ URL::to('shipping-detail') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{ translate('Service') }}</label>
                            <div class="col-md-9">
                                <input type="text" placeholder="{{ translate('Service') }}" id="name" name="service"
                        ...
                        <div style="display:none" class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="hidden" value="0" required name="gst_rate" class="form-control"
                                    id="order_level" placeholder="{{ translate('Gst Rate') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 col-from-label">{{ translate('Unit in KG') }}</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="unit" id="unit"
                                    placeholder="Unit in KG" required readonly>
                            </div>
                        </div>
                        <div class="form-group row" id="weight_price" style="display: none;">
                            <label class="col-md-3 col-form-label" id="weight_price_label">
                                Per Unit Price
                            </label>
                            <div class="col-md-9">
                                <input type="number" step="0.000000001" class="form-control" id="unit_price" placeholder="Per unit Price">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">
                            ...
                            <div class="col-md-9">
                                <input type="number" step="0.01" name="kg" class="form-control" id="unit_price_kg"
                                    readonly placeholder="{{ translate('Per Kg Price') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="price_currecny" required>
                                    ...
                                    @foreach (App\Currency::where('status', '1')->get() as $itemcurrency)
                                        <option value="{{ $itemcurrency->id }}">{{ $itemcurrency->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" required name="transit_day" class="form-control" id="order_level"
                                    placeholder="{{ translate('Transit Days') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control aiz-selectpicker" data-live-search="true"
                                    name="country_id_arrival" id="country_id_arrival" required>
                                    <option value="">{{ translate('Select Country') }}</option>
                                    @foreach ($countries as $country)
                                        <option value="{{ $country->name }}">
                                            {{ $country->name }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control mb-3 aiz-selectpicker" data-live-search="true"
                                    name="state_id_arrival" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <select class="form-control mb-3 aiz-selectpicker" data-live-search="true"
                                    name="city_id__arrival" required>
...
@section('script')
    <script  type="module">
        ...
        function convert_unit() {
                const unit = $('#unit').val(),
                    value = $('#unit_price').val();
            $('#unit_price_kg').val(parseFloat(unit) * parseFloat(value))
        }
        $('#unit_select').on('change', function() {
            const value = $(this).val();
            
            const weight_value = convert(1, value).to('kilogram');

            $('#unit').val(weight_value);
            var short = '';
            switch (value) {
                case 'kilogram':
                    short = 'kg';
            ...
            const content =`Per ${short} Price`;       
            $('#weight_price_label').html(content);   
            $('#weight_price').show();
            convert_unit()
        });
        $('#unit_price').on('keyup', function(e) {
            ...
            console.log(parseFloat(unit) * parseFloat(e.target.value));
            convert_unit();
        })
    </script>
