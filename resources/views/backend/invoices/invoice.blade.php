...
<body>
	<div>
		...
		<div style="background: #102847;padding: 1rem;">
			<table>
				<tr>
					<td>
						@if($logo != null)
					...
					<td style="font-size: 1.5rem;color:white" class="text-right strong">{{  translate('INVOICE') }}</td>
				</tr>
			</table>
			<table>
				<tr>
					<td style="font-size: 1rem;color:white" class="strong">{{ get_setting('site_name') }}</td>
				...
				<tr>
					...
					<td class="text-right small"><span class="gry-color small">{{  translate('Order ID') }}:</span> <span style="color:white" class="strong">{{ $order->code }}</span></td>
				</tr>
				<tr>
					<td class="gry-color small">{{  translate('Phone') }}: {{ get_setting('contact_phone') }}</td>
					<td class="text-right small"><span class="gry-color small">{{  translate('Order Date') }}:</span> <span style="color:white" class=" strong">{{ date('d-m-Y', $order->date) }}</span></td>
				</tr>
			</table>
