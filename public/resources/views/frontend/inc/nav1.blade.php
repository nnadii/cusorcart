...
@endif
<!-- Top Bar -->
<div style="background-color: #102847!important;" class="top-navbar bg-white border-bottom border-soft-secondary z-1035">
    <div class="container">
        <div class="row">
...
<!-- END Top Bar -->
<header style="background-color: #102847!important;" class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
    ...
    @if ( get_setting('header_menu_labels') !=  null )
        <div style="background-color: #102847!important;"  class="bg-white border-top border-gray-200 py-1">
            <div class="container">
