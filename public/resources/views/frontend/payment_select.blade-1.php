...
<section class="mb-4">
    ...
    $ship = explode(" ",$ship_id);
@endphp
                    @foreach($carts as $ownre_id)
                    <input type="hidden" name="owner_id[]" value="{{ $ownre_id->owner_id }}">
                    @endforeach
                     <input type="hidden" id="" name="ship_payment" value="{{$service}}">
                    
                     @foreach($ship as $newship_id) 
                     <input type="hidden" id="" name="ship_id[]" value="{{$newship_id}}">
                    @endforeach
                    
                    <input type="hidden" name="kgproduct" value="{{$shipping}}"/>
                    ...
                    <div class="pt-3">
                        ...
                        <a style="color: blue;" href="{{ route('terms') }}">{{ translate('terms and conditions')}}</a>,
                        <a style="color: blue;" href="{{ route('returnpolicy') }}">{{ translate('return policy')}}</a> &
                        <a style="color: blue;" href="{{ route('privacypolicy') }}">{{ translate('privacy policy')}}</a>
                    </div>

                    <div class="row align-items-center pt-3">
                        <div class="col-6">
                            <a style="color: blue;" href="{{ route('home') }}" class="link link--style-3">
