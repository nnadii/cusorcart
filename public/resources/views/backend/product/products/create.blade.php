                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="brand">
                            ...
                            <div class="col-md-8">
                                <input list="brands" class="form-control aiz-selectpicker" name="brand_id" id="brand_id" data-live-search="true"/>
                                <datalist id="brands">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="kg" placeholder="Weight in Kg" required>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row" style="margin-bottom: 70px;">
                            ...
                            <div class="col-md-8">
                                <div class="quill-text-editor" name="description"></div>
                            </div>
                        </div>
                    </div>
                </div>
