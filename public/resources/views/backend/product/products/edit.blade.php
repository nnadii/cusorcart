                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker" name="category_id" id="category_id" data-selected="{{ $product->category_id }}" data-live-search="true" required>
                                    ...
                                    <option disabled value="{{ $category->id }}">{{ $category->getTranslation('name') }}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                              ...
                              <div class="form-group row">
                            <label class="col-lg-3 col-from-label">Weight in Kg<i class="las la-language text-danger" title="{{translate('Translatable')}}"></i> </label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="kg" placeholder="Weight in Kg" value="{{$product->kg }}" required>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control aiz-date-range" value="{{ $product->discount_start_date ? $start_date.' to '.$end_date : '' }}" name="date_range" placeholder="Select Date" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row" style="margin-bottom: 70px;">
                            ...
                            <div class="col-lg-9">
                                <textarea id="quill-slug" style="display:none" name="description"></textarea>
