...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{URL::to('shipping-detail',$ship->id)}}" method="POST" enctype="multipart/form-data">
                	@csrf
                	@method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="{{translate('Service')}}" id="name" name="service" value="{{$ship->service}}" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <!--    </label>-->
                    <!--    <div class="col-md-9">-->
                    <!--        <input type="number"required  name="service_charges" class="form-control" id="order_level" value="{{$ship->service_charges}}" placeholder="{{translate('Service Charges')}}">-->
                    ...
                    <div style="display:none" class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="hidden required" name="gst_rate" class="form-control" id="order_level" value="{{$ship->gst_rate}}" placeholder="{{translate('Gst Rate')}}">
                 ...
                 <!--       </label>-->
                 <!--       <div class="col-md-9">-->
                 <!--           <input type="number"  name="amount" class="form-control" id="order_level" value="{{$ship->amount}}" placeholder="{{translate('Amount')}}">-->
                 ...
                 <!--   </div>-->
                   <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" required  name="transit_day" class="form-control" id="order_level" value="{{$ship->transit_day}}" placeholder="{{translate('Transit Days')}}">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number"   name="kg" class="form-control" id="order_level" value="{{$ship->kg}}"  placeholder="{{translate('Per Kg Price')}}">
                       ...
                       <div class="form-group row">
                            ...
                            @if($ship->price_currecny == $itemcurrency->id) selected @endif
                    ...
                    <!--    </label>-->
                    <!--    <div class="col-md-9">-->
                    <!--        <input type="number" required value="{{$ship->shipping_tax}}"  name="shipping_tax" class="form-control"  placeholder="{{translate('Shipping Tax')}}">-->
                    ...
                    <div class="col-sm-9">
                        ...
                        @foreach ($countries as $country)
                                <option value="{{ $country->name }}" @if($ship->country == $country->name) selected @endif>
                                    {{ $country->name }}
                                </option>
                            @endforeach    </select>
                    </div>
				...
				<div class="row">
                    ...
                    <div class="col-md-9">
                        <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="state_id" required>
                         <option value="{{$ship->state}}">{{ $ship->state }}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control aiz-selectpicker" data-live-search="true" name="country_id_arrival" id="country_id_arrival" required>
                            <option value="">{{translate('Select Country')}}</option>
                                @foreach ($countries as $country)
                                <option value="{{ $country->name }}" @if($ship->ship_country == $country->name) selected @endif>
                                    {{ $country->name }}
                                </option>
                            @endforeach
				...
				<div class="row">
                    ...
                    <div class="col-md-9">
                        <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="state_id_arrival" required>
                             <option value="{{$ship->ship_state}}">{{ $ship->ship_state }}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="city_id__arrival" required>
                               <option value="{{$ship->ship_city}}">{{ $ship->ship_city }}</option>
