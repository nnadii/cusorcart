                        ...
                        @foreach ($completed_deliveries as $key => $delivery)
                            @if(optional($delivery->order)->code)
                                <tr>
                                    ...
                                    <td>
                                        {{ single_price($delivery->order->grand_total) }}
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-right">
                                        <a href="javascript:void(0)" class="btn btn-soft-info btn-icon btn-circle btn-sm" onclick="show_purchase_history_details({{ $delivery->order->id }})" title="{{ translate('Order Details') }}">
